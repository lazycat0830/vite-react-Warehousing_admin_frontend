...
function SalesInerface(props) {
  ...
  const filteredInventory = useMemo(() => {
    ...
    return _.filter(
      AllInventory,
      (item) =>
        item.pro_homemadeName.includes(search) ||
        item.pro_comName.includes(search)
    );
  }, [search, AllInventory]);
      ...
      <Grid style={{ height: "100%" }}>
        ...
        >
          ...
          <Stack justify="space-between" align="stretch" h={200}>
            ...
            <Button style={{ height: 50, fontSize: "1.5rem" }} fullWidth>
              結帳
            </Button>
          </Stack>
        </Grid.Col>
